...
public class DateUtil {
	 ...
	 */
	public static Calendar toCalendar(String strDate) throws InputErrorException{
		try{
			...
			switch (len) {
				...
				default :
					...
					err.setMessage("引数の文字列["+ strDate +	"]は日付文字列に変換できません");
			}
			return cal;
		}catch(Exception e){
			InputErrorException err = new InputErrorException();
			err.setMessage("日付文字列に変換できません");
			throw err;
		}
	}
